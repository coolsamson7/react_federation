  ...
  const panelConfigs: PanelConfig[] = [
    {
      ...
      icon: (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
          <path d="M7.5 0a7.5 7.5 0 0 0-5.419 12.735l.53.53A7.472 7.472 0 0 0 7.5 15c1.847 0 3.545-.665 4.889-1.765l.53-.53A7.5 7.5 0 0 0 7.5 0zM6 5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm1.5 3.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm3.5-1.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm-1.5 5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"/>
        </svg>
      ),
      position: "left"
    },
